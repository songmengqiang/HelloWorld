...
public class BuyerWindow extends JDialog {
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    initialize () ;
    queryDataSet1.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
  ...
  void jButton2_actionPerformed(ActionEvent e) {
    ...
    switch(queryOrderForm.gettestQuery()){
      case 1:
        ...
        queryDataSet2.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
      ...
      case 2:
        ...
        queryDataSet3.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
      ...
      case 3:
        ...
        queryDataSet4.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
      ...
      case 4:
        ...
        queryDataSet5.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
