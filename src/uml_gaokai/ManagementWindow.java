...
public class ManagementWindow extends JDialog {
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    ...
    queryDataSet1.setQuery(new QueryDescriptor(database1, "SELECT Buyer_TABLE.BuyerID,Buyer_TABLE.BuyerGoodsName,Buyer_TABLE.BuyerGoodsNumber,Buyer_TABLE.BuyerM" +
        ...
        "FROM Buyer_TABLE", null, true, Load.ALL));
  ...
  void jButton2_actionPerformed(ActionEvent e) {
    intilize();
    queryDataSet2.setQuery(new QueryDescriptor(database1, "SELECT vendition_TABLE.VenditionID,vendition_TABLE.GoodsName,vendition_TABLE.GoodsCustomNumber,vendit" +
