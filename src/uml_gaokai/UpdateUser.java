  ...
  void jButton1_actionPerformed(ActionEvent e) {
    ...
    if(userPassword.equals(testPassword)){
      try{
        ...
        sql1.executeUpdate("UPDATE user SET userAge = '"+userAge+"',userGender = '"+userGender+"', userAuthority = '"+userAuthority+"', userAddress = '"+userAddress+"' , userPassword = '"+userPassword+"' WHERE userName = '"+userName+"'") ;
